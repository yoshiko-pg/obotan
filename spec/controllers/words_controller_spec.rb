  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved word as @word" do
        ...
        post :create, {:word => { "user_id" => "invalid value" }}, valid_session
        assigns(:word).should be_a_new(Word)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested word" do
        ...
        Word.any_instance.should_receive(:update).with({ "user_id" => "1" })
        put :update, {:id => word.to_param, :word => { "user_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the word as @word" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Word.any_instance.stub(:save).and_return(false)
        put :update, {:id => word.to_param, :word => { "user_id" => "invalid value" }}, valid_session
        assigns(:word).should eq(word)
      end
